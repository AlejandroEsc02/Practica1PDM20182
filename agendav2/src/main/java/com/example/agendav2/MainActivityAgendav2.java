...
public class MainActivityAgendav2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_agendav2);
    ...
    public void gover (View view){
        Intent intent1 =new Intent(MainActivityAgendav2.this,MainActivityVer.class);
        startActivity(intent1);

    }
    public void goregistrar (View view){
        Intent intent2 =new Intent(MainActivityAgendav2.this,MainActivityRegistrar.class);
        startActivity(intent2);

    }
    public void gobuscar (View view){
        Intent intent3 =new Intent(MainActivityAgendav2.this,MainActivityBuscar.class);
        startActivity(intent3);

    }
    public void goeliminar (View view){
        Intent intent4 =new Intent(MainActivityAgendav2.this,MainActivityEliminar.class);
